...
public class DebugFive2{
   public static void main(String args[]){
      ...
      num = input.nextInt(); //Added () after nextInt
      
      System.out.print("Enter another number ");
      num2 = input.nextInt(); //Fixed by adding () after nextInt
      
      if((num % num2 == 0) || (num2 % num) == 0){ //Used % and || to check if one number divides the other
